...
function Projects() {
  const redirectToDemo = () => {
    window.open("https://jbtokam-ecommerce-app-ee82c68a5d0d.herokuapp.com/", "_blank");
  };
              ...
              <div className="col-md-4" key={project.id}>
                <div className="position-relative project">
                  ...
                  <div className="project-content">
                    ...
                    {/* DEMO button with onClick event */}
                    <button className='primary-button' onClick={redirectToDemo}>DEMO</button>
                  </div>
                </div>
              </div>
            );
